...
class NWPU_RESISC45(Dataset):
    def __init__(self, root_dir, classes, transform=None, max_images_per_class=None):
        ...
        for class_idx, class_name in enumerate(classes):
            ...
            if max_images_per_class is not None:
                img_names = sample(img_names, min(max_images_per_class, len(img_names)))
...
class MixedResolutionCNN(nn.Module):
    def __init__(self, num_classes=5, num_kernels=1):
        ...
        self.low_res_conv = nn.Conv2d(3, 3, kernel_size=3, stride=1, padding=1)
...
def main():
    ...
    root_dir = r"C:\Users\MaxSc\Desktop\letest\minimalexamples\dataset\NWPU-RESISC45"  # Update this path to where the dataset is located
    ...
    # Load the dataset
    dataset = NWPU_RESISC45(root_dir=root_dir, classes=classes, transform=transform, max_images_per_class=200)
